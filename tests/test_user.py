...
from TicTacToe.src.User import DifficultyLevel, User
...
def test_is_computer_playing_returns_true(user, user_input, monkeypatch):
...
def test_is_computer_playing_returns_false(user, user_input, monkeypatch):
    def mock_input(_) -> str:
        return user_input
    monkeypatch.setattr('builtins.input', mock_input)
...
def test_is_computer_playing_returns_none(user, user_input, monkeypatch):
    def mock_input(_) -> str:
        return user_input
    monkeypatch.setattr('builtins.input', mock_input)
...
@pytest.mark.parametrize("user_input", ['n', "N"])
def test_does_computer_go_first_returns_true(user, user_input, monkeypatch):
    def mock_input(_) -> str:
        return user_input
    monkeypatch.setattr('builtins.input', mock_input)
...
@pytest.mark.parametrize("user_input", ['q', "Q"])
def test_does_computer_go_first_returns_none(user, user_input, monkeypatch):
    def mock_input(_) -> str:
        return user_input
    monkeypatch.setattr('builtins.input', mock_input)
...
def test_get_difficulty_level_returns_medium(user, monkeypatch):
    def mock_input(_) -> str:
        return '2'
    monkeypatch.setattr('builtins.input', mock_input)
...
def test_get_difficulty_level_returns_hard(user, monkeypatch):
    def mock_input(_) -> str:
        return '3'
    monkeypatch.setattr('builtins.input', mock_input)
...
def test_get_difficulty_level_returns_unbeatable(user, monkeypatch):
    def mock_input(_) -> str:
        return '4'
    monkeypatch.setattr('builtins.input', mock_input)
...
@pytest.mark.parametrize("user_input", ['q', "Q"])
def test_get_difficulty_level_returns_none(user, user_input, monkeypatch):
    def mock_input(_) -> str:
        return user_input
    monkeypatch.setattr('builtins.input', mock_input)
...
def test_is_playing_again_returns_false(user, user_input, monkeypatch):
    def mock_input(_) -> str:
        return user_input
    monkeypatch.setattr('builtins.input', mock_input)
