...
YES_NO_QUIT_INPUT_OPTIONS = (f"[{UserInput.YES.value}/{UserInput.NO.value} " +
    f"or {UserInput.QUIT.value} to {UserInput.QUIT.name.lower()}]"
)
...
class User:
    ...
    def is_computer_playing(self) -> Optional[bool]:
        while True:
            user_input: str = input("\nDo you want to play against the " +
                f"computer? {YES_NO_QUIT_INPUT_OPTIONS}: "
            ).strip().lower()
